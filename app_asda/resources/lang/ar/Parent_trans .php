...
return [
    ...
    'Name_Father_en' => 'اسم الاب  باللغة الفرنسية',
    'Job_Father' => 'اسم الوظيفة باللغة العربية',
    'Job_Father_en' => 'اسم الوظيفة باللغة الفرنسية',
    ...
    'Name_Mother_en' => 'اسم الام  باللغة الفرنسية',
    'Job_Mother' => 'اسم الوظيفة باللغة العربية',
    'Job_Mother_en' => 'اسم الوظيفة باللغة الفرنسية',
