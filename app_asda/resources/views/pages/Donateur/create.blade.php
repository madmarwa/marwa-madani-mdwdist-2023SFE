            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{route('Donateurs.store')}}" method="post">
                             @csrf
                             <div class="form-row">
                                <div class="col">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <label for="exampleFormControlTextarea1">{{trans('Donateur_trans.Phone_Donateur')}}</label>
                                    <input type="text" name="Phone_Donateur" class="form-control">
