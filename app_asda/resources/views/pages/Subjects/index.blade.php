...
@section('css')
    @toastr_css
@section('title')
{{trans('subjcet_trans.Liste_matiere')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('subjects.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">{{trans('subjcet_trans.Ajouter')}}  </a><br><br>
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th>{{trans('subjcet_trans.Nom')}} </th>
                                            <th> {{trans('Grades_trans.title_page')}} </th>
                                            <th>  {{trans('My_Classes_trans.title_page')}} </th>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">  {{trans('subjcet_trans.Supprimer')}} </h5>
