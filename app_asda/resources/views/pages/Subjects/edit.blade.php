...
@section('css')
    @toastr_css
@section('title')
{{trans('subjcet_trans.Editer_matiere')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{route('subjects.update','test')}}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">  {{trans('subjcet_trans.Nom_arabe')}}  </label>
                                    ...
                                    <div class="col">
                                        <label for="title">{{trans('subjcet_trans.Nom_fran')}}    </label>
                                        <input type="text" name="Name_en"
                                               value="{{ $subject->getTranslation('name', 'fr') }}"
                                               class="form-control">
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="inputState"> {{trans('Grades_trans.title_page')}} </label>
                                    ...
                                    <div class="form-group col">
                                        <label for="inputState"> {{trans('My_Classes_trans.title_page')}}</label>
