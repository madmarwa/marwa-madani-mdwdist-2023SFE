                            ...
                            <div class="tab-content">
                                    ...
                                    <table class=" table table-bordered" style="text-align:center">
                                        ...
                                        <tr class="table-success">
                                         ...
                                         <th scope="row">{{trans('Students_trans.gender')}}</th>
                                            ...
                                            <th scope="row">{{trans('Students_trans.Greffe_Cochlee')}}</th>
                                            <th scope="row">{{trans('Students_trans.Date_Greffe_Cochlee')}}</th>
                                             <tr> 
                                             <td>{{ $Student->name }}</td>
                                            ...
                                            <td>{{ $Student->date_greffe_cochlee ?? '------------' }}</td>
                                ...
                                <div class="tab-pane fade" id="profile-02" role="tabpanel"
                                    ...
                                    <div class="card card-statistics">
                                        ...
                                        <br>
                                        <table class="table  table-bordered center-aligned-table mb-0 table table-hover"
