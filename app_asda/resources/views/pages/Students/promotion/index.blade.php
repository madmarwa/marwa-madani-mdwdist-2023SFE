            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <h6 style="color: red;font-family: Cairo">   {{trans('main_trans.Ancienne_etape')}} </h6><br>
                    ...
                    <form method="post" action="{{ route('Promotion.store') }}">
                        ...
                        <br><h6 style="color: red;font-family: Cairo"> {{trans('main_trans.Nouvelle_etape')}}  </h6><br>
                        ...
                        <button type="submit" class="btn btn-primary"> {{trans('main_trans.Confirmation')}}</button>
                    </form>
