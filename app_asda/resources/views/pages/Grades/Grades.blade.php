...
<!--<form action="{{ URL::current() }}" method="get" class="d-flex justify-content-between mb-4">
    <x-form.input name="Name" placeholder="Name" class="mx-2" :value="request('Name')" id="search-input" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $Grade->getTranslation('Name', 'fr') }}"
        ...
        function fetchSearchResults(query) {
            $.ajax({
                ...
                success: function(response) {
                    // Mettez à jour votre liste de résultats ou faites autre chose avec la réponse
