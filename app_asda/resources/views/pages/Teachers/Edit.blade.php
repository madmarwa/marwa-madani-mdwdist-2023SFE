                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="Name_en" value="{{ $Teachers->getTranslation('Name', 'fr') }}" class="form-control">
                                    @error('Name_en')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <label for="title">{{trans('Teacher_trans.specialization_ar')}}</label>
                                ...
                                <div class="col">
                                    <label for="title">{{trans('Teacher_trans.specialization_en')}}</label>
