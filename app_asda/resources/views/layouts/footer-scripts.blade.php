...
<script>
   $(document).ready(function() {
    $('#datatable').DataTable({
        language: {
            searchPlaceholder: "{{ trans('main_trans.Recherchez_ici') }}", 
...
@if (App::getLocale() == 'fr')
    <script src="{{ URL::asset('assets/js/bootstrap-datatables/fr/jquery.dataTables.min.js') }}"></script>
    <script src="{{ URL::asset('assets/js/bootstrap-datatables/fr/dataTables.bootstrap4.min.js') }}"></script>
    <script src="//cdn.datatables.net/plug-ins/1.13.4/i18n/fr-FR.json"></script>
@else
